...
<!-- 지시자(directive) jsp 태그 : jsp 페이지의 속성 및 정보, import문을 표현할 때 사용-->
...
<%
    ...
    // 나중에 jsp 파일이 서블릿(클래스)으로 변환될 때
    // 스크립틀릿에 작성된 내용은 서블릿의 메서드 바디로 적용됨
    ...
    <ul>
        <%
            for (Dancer dancer : DancerRepository.findAll()) {
                // jsp 파일 내에서는 브라우저로 바로 출력을 담당하는 out 내장 객체의 write()를 사용
